...
// Check if file belongs to this page
if ($fileInfo['page'] !== $currentPage) {
    die('This file is not available on this page.');
}
...
<body>
    ...
    <div class="container download-container">
        <div class="download-card">
            <div class="page-badge">📄 Page 5</div>
            ...
            <div class="password-hint">
                <div class="password-hint-label">Hint: Password</div>
